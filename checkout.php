...
<body>
    ...
    <div class="checkout">
        <div class="container">
            <h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di
                Sipebu</span></h1>
        ...
        <div class="checkout-left">
            <div class="checkout-left-basket">
                ...
                <ul>
                    ...
                    <h1><input type="text" value="Rp<?php echo number_format($subtotal + $ongkir) ?>" disabled \></h1>
                </ul>
            </div>
            <br>
