...
session_start();
	...
	if(isset($_POST['addmethod']))
	{
		...
		$an = $_POST['an'];
		// $logo = $_POST['logo'];
		// var_dump($_FILES['uploadgambar']['name']);
        // die;
		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 5000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
			  ...
			  $query = "insert into pembayaran (metode, norek, logo, an)
			  values('$metode','$norek','$pathdb','$an')";
...
<head>
    ...
    <title>Kelola Metode Pembayaran - SIPEBU</title>
                            ...
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal"
                                        class="btn btn-info col-md-2">Tambah Metode</button>
                                </div>
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
											$brgs=mysqli_query($conn,"SELECT * from pembayaran order by idpembayaran ASC");
											$no=1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary mb-2"
                                                        href="edit_pembayaran.php?idpembayaran=<?=$p["idpembayaran"];?>"
                                                        role="button">edit</a>
                                                    <a class="btn btn-danger mb-2"
                                                        href="delete.php?idpembayaran=<?=$p["idpembayaran"];?>"
