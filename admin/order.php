...
if(isset($_POST['kirim']))
	{
        $noresi = $_POST['noresi'];
        // var_dump($noresi);
        // $updatenoresi= mysqli_query($conn,"insert into cart (no_resi) values('$noresi') where orderid='$orderids'");
        // die;
		$updatestatus = mysqli_query($conn,"update cart set status='Pengiriman' where orderid='$orderids'");
		$updatenoresi= mysqli_query($conn,"update cart set no_resi='$noresi' where orderid='$orderids'");
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
									...
									if($checkdb['status']=='Confirmed'){
										...
										while($tarik=mysqli_fetch_array($ambilinfo)){		
                                            ...
                                            echo '
                                                ...
                                                <br><br>
                                                <div class="foto"><img class = "foto_pembayaran" src="../'.$foto.'" height="100px" \></div>
                                                
                                                <form method="post">
                                                    <label>Nomor Resi</label>
                                                    <input name="noresi" type="text" class="form-control my-4" width="50%" required
                                                        autofocus>
                                ...
                                echo '
                                <form method="post">
                                    <input type="submit" name="selesai" class="form-control btn btn-success"
                                        value="Selesaikan" \>
                                </form>
                                ';
                                }
