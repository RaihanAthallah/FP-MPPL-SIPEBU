		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 5000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
			  ...
			  $query = "insert into produk (idkategori, namaproduk, gambar, deskripsi, harga, stok)
			  values('$idkategori','$namaproduk','$pathdb','$deskripsi','$harga','$stok')";
...
<head>
    ...
    <title>Kelola Produk - SIPEBU</title>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary mb-2"
                                                        href="edit_produk.php?idproduk=<?=$p["idproduk"];?>"
                                                        role="button">edit</a>
                                                    <a class="btn btn-danger mb-2"
                                                        href="delete.php?q=produk&id=<?=$p["idproduk"];?>"
