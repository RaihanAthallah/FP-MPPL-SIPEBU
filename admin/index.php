<?php 
    session_start();
	if((!isset($_SESSION['logPegawai']))&&(!isset($_SESSION['logManajer']))){
    ...
    // $sql ="SELECT date_format(cart.tglorder, '%M') AS 'bulan' ,SUM(detailorder.qty * produk.harga) AS 'pendapatan'
    //    FROM cart,detailorder,produk
    //    WHERE cart.orderid = detailorder.orderid AND detailorder.idproduk = produk.idproduk 
    //    GROUP BY date_format(cart.tglorder, '%M')
    //    ORDER by cart.tglorder ASC;";
                ...
                <div class="menu-inner">
                    <nav>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="riwayat.php"><i class="ti-dashboard"></i><span>Riwayat Pesanan</span></a>
                            </li>
                            <li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="market-status-table mt-4">
                                        ...
                                        <br>
                                        <p>Pada halaman admin, Anda dapat menambah kategori produk, mengelola
                                            produk,
                    ...
                    <div>
                        ...
                        <div class="data-tables datatable-dark">
                            <table id="dataTable3" class="display" style="width:100%">
                                ...
                                <tbody>
                                    <?php 
											$brgs=mysqli_query($conn,"SELECT namaproduk,SUM(detailorder.qty) as total_penjualan FROM `detailorder`,`produk`,`cart` WHERE detailorder.idproduk = produk.idproduk AND detailorder.orderid = cart.orderid AND cart.status LIKE '%Selesai%' GROUP BY namaproduk ORDER BY `total_penjualan` DESC;");
											$no=1;
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $p['total_penjualan'] ?></td>
                                    </tr>
